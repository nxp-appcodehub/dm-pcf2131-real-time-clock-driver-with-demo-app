...
void BOARD_InitPins(void)
{
	...
	const port_pin_config_t port0_10_pinF8_config = {/* Internal pull-up/down resistor is disabled */
			kPORT_PullDisable,
			/* Low internal pull resistor value is selected. */
			kPORT_LowPullResistor,
			/* Fast slew rate is configured */
			...
			/* Pin Control Register fields [15:0] are not locked */
			kPORT_UnlockRegister};
	/* PORT0_10 (pin F8) is configured as PIO0_10 */

	PORT_SetPinConfig(PORT0, 10U, &port0_10_pinF8_config);
